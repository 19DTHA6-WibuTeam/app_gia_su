...
class SessionChild3Detail extends StatefulWidget {
  int sessionId;
  ...
  @override
  State<SessionChild3Detail> createState() => _SessionChild3DetailState();
}

class _SessionChild3DetailState extends State<SessionChild3Detail> {
  @override
  void initState() {
    super.initState();
